 ...
 *      调用：
 *           1.ExportUtil exportUtil = new ExportUtil(columnWidth, title, headers, fieldList);
 *           2.exportUtil.export(sheetName, list);
 *           2.exportUtil.exportDict(sheetName, list, dictMap);
 *           2.exportUtil.exportFVDict(sheetName, list, fieldValueMap, dictMap);
 *           3.InputStream inputStream = exportUtil.getWorkbook();
 */
public class ExportUtil {
     ...
     */
    public ExportUtil(int columnWidth, String title, String[] headers, String[] fieldList) {
