...
//        //1、浮点数类型转换为String时特别注意，如果数值类型是包装类为null时
        Double d = null;
        String result = String.valueOf(d);// 转为字符串"null"。
...
//
//        //总结：如果是基本浮点类型的数值，使用String.valueOf(BigDecimal.valueOf(d));
//        //     如果是包装浮点类型的数值，使用String.valueOf(BigDecimal.valueOf(Optional.ofNullable(d).orElse(0.0)));
